...
├── admin.html                    ← 管理画面（pending承認, downgrade確認等）
...
| HTML | 638-731 | DOM構造（#map, #bottom, #sheet, picker, nudge） |
...
| loadPendingToilets() | 1272-1309 | pending_toilets fetch（cityKeyフィルタあり） |
| renderCity() | 1310-1341 | allMarkers生成, applyFilter, renderNearby |
| renderNearby() | 1388-1457 | 近傍リスト（searchPin/GPS起点, stageExpand） |
| selectCity() | 1458-1484 | 都市ピッカーから切り替え |
| openDetail() | 1562-1638 | 詳細シート（星, 顔, 投票, 3Dボタン） |
| answerQ1/Q2/Q3 | 1639-1698 | 投票ステップ（localStorage制限, reviewSummaries） |
| submitAdd | 1810-1863 | トイレ追加（admin直接 or pending+EmailJS） |
| startInlineReview | 1919-1950 | インラインレビュー起動 |
| submitReview | 1951-1980 | 詳細レビュー送信 |
| goToSearchResult | 1996-2033 | 検索結果 → 地図移動・loadCity |
| switchTab() | 2034-2068 | Near/Searchタブ切り替え |
| searchCity | 2069-2125 | Google Places Autocomplete (New) |
| renderInlineLegend | 2126-2146 | 地図内凡例レンダリング |
| init() | 2200-2248 | 起動フロー（geolocation, loadCity, invalidateSize） |
